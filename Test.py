...
button1 = tk.Button(root, text="Start", bg="green", fg="white", image=image1, compound="left", height=100, width=100)
...
button2 = tk.Button(root, text="Button 2", width=100)
button2.grid(row=0, column=1)

# Bind the function to the button 3
button3 = tk.Button(root, text="Button 3", command=change_button1,width=100)
